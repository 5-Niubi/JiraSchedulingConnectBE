namespace ModelLibrary.DBModels
{
    public partial class Task
    {
        ...
        public virtual ICollection<TaskFunction> TaskFunctions
        {
            get; set;
        }
        public virtual ICollection<TaskPrecedence> TaskPrecedencePrecedences
        {
            get; set;
        }
        public virtual ICollection<TaskPrecedence> TaskPrecedenceTasks
        {
            get; set;
        }
        public virtual ICollection<TasksSkillsRequired> TasksSkillsRequireds
        {
            get; set;
        }
    }
